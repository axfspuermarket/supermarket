...
SECRET_KEY = 'c%(ok#=i5@*rb!da)lxbtpd+d^3*+$3o%hbfia3meont$2!%rd'
DEBUG = False
...
LOGGING = {
    ...
    'handlers': {
        ...
        'info': {
            ...
            'filename': f'{BASE_DIR}/log/info.log',  # 日志保存路径
            'when': 'D',  # 每天切割日志
        ...
        'error': {
            'class': 'logging.handlers.TimedRotatingFileHandler',
            'filename': f'{BASE_DIR}/log/error.log',  # 日志保存路径
            'when': 'W0',  # 每周一切割日志
...
STATIC_URL = '/static/'
STATIC_MEDIA_ROOT = os.path.join(BASE_DIR, 'static/uploads')
STATICFILES_DIRS = [
